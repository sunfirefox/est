 ...
 */
static uchar md5_test_buf[7][81] = {
    {""},
    {"a"},
    {"abc"},
    {"message digest"},
...
static const uchar md5_test_sum[7][16] = {
    {
 ...
 */
static uchar md5_hmac_test_key[7][26] = {
...
static uchar md5_hmac_test_buf[7][74] = {
    {"Hi There"},
...
static const uchar md5_hmac_test_sum[7][16] = {
    {
