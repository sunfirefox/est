 ...
 */
static uchar sha1_test_buf[3][57] = {
    {"abc"},
...
static const uchar sha1_test_sum[3][20] = {
    {
 ...
 */
static uchar sha1_hmac_test_key[7][26] = {
    {
...
static uchar sha1_hmac_test_buf[7][74] = {
    {"Hi There"},
...
static const uchar sha1_hmac_test_sum[7][20] = {
    {
