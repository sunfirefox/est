 ...
 */
void sha2_hmac_starts(sha2_context * ctx, uchar *key, int keylen,
              int is224)
{
    int i;
    uchar sum[32];
 ...
 */
static uchar sha2_test_buf[3][57] = {
    {"abc"},
...
static const uchar sha2_test_sum[6][32] = {
    /*
 ...
 */
static uchar sha2_hmac_test_key[7][26] = {
    {
...
static uchar sha2_hmac_test_buf[7][153] = {
    {"Hi There"},
...
static const uchar sha2_hmac_test_sum[14][32] = {
    /*
