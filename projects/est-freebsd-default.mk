...
$(CONFIG)/obj/aes.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/aes.o $(LDFLAGS) -fPIC $(DFLAGS) "$(IFLAGS)" src/aes.c
...
$(CONFIG)/obj/arc4.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/arc4.o $(LDFLAGS) -fPIC $(DFLAGS) "$(IFLAGS)" src/arc4.c
...
$(CONFIG)/obj/base64.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/base64.o $(LDFLAGS) -fPIC $(DFLAGS) "$(IFLAGS)" src/base64.c
...
$(CONFIG)/obj/bignum.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/bignum.o $(LDFLAGS) -fPIC $(DFLAGS) "$(IFLAGS)" src/bignum.c
...
$(CONFIG)/obj/camellia.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/camellia.o $(LDFLAGS) -fPIC $(DFLAGS) "$(IFLAGS)" src/camellia.c
...
$(CONFIG)/obj/certs.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/certs.o $(LDFLAGS) -fPIC $(DFLAGS) "$(IFLAGS)" src/certs.c
...
$(CONFIG)/obj/debug.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/debug.o $(LDFLAGS) -fPIC $(DFLAGS) "$(IFLAGS)" src/debug.c
...
$(CONFIG)/obj/des.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/des.o $(LDFLAGS) -fPIC $(DFLAGS) "$(IFLAGS)" src/des.c
...
$(CONFIG)/obj/dhm.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/dhm.o $(LDFLAGS) -fPIC $(DFLAGS) "$(IFLAGS)" src/dhm.c
...
$(CONFIG)/obj/havege.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/havege.o $(LDFLAGS) -fPIC $(DFLAGS) "$(IFLAGS)" src/havege.c
...
$(CONFIG)/obj/md2.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/md2.o $(LDFLAGS) -fPIC $(DFLAGS) "$(IFLAGS)" src/md2.c
...
$(CONFIG)/obj/md4.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/md4.o $(LDFLAGS) -fPIC $(DFLAGS) "$(IFLAGS)" src/md4.c
...
$(CONFIG)/obj/md5.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/md5.o $(LDFLAGS) -fPIC $(DFLAGS) "$(IFLAGS)" src/md5.c
...
$(CONFIG)/obj/net.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/net.o $(LDFLAGS) -fPIC $(DFLAGS) "$(IFLAGS)" src/net.c
...
$(CONFIG)/obj/padlock.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/padlock.o $(LDFLAGS) -fPIC $(DFLAGS) "$(IFLAGS)" src/padlock.c
...
$(CONFIG)/obj/rsa.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/rsa.o $(LDFLAGS) -fPIC $(DFLAGS) "$(IFLAGS)" src/rsa.c
...
$(CONFIG)/obj/sha1.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/sha1.o $(LDFLAGS) -fPIC $(DFLAGS) "$(IFLAGS)" src/sha1.c
...
$(CONFIG)/obj/sha2.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/sha2.o $(LDFLAGS) -fPIC $(DFLAGS) "$(IFLAGS)" src/sha2.c
...
$(CONFIG)/obj/sha4.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/sha4.o $(LDFLAGS) -fPIC $(DFLAGS) "$(IFLAGS)" src/sha4.c
...
$(CONFIG)/obj/ssl_cli.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ssl_cli.o $(LDFLAGS) -fPIC $(DFLAGS) "$(IFLAGS)" src/ssl_cli.c
...
$(CONFIG)/obj/ssl_srv.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ssl_srv.o $(LDFLAGS) -fPIC $(DFLAGS) "$(IFLAGS)" src/ssl_srv.c
...
$(CONFIG)/obj/ssl_tls.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ssl_tls.o $(LDFLAGS) -fPIC $(DFLAGS) "$(IFLAGS)" src/ssl_tls.c
...
$(CONFIG)/obj/timing.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/timing.o $(LDFLAGS) -fPIC $(DFLAGS) "$(IFLAGS)" src/timing.c
...
$(CONFIG)/obj/x509parse.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/x509parse.o $(LDFLAGS) -fPIC $(DFLAGS) "$(IFLAGS)" src/x509parse.c
...
$(CONFIG)/obj/xtea.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/xtea.o $(LDFLAGS) -fPIC $(DFLAGS) "$(IFLAGS)" src/xtea.c
