#
#   est-freebsd-default.mk -- Makefile to build Embedded Security Transport for freebsd
#
...
$(CONFIG)/obj/aes.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/aes.o -O2 -fPIC $(DFLAGS) "$(IFLAGS)" src/aes.c
...
$(CONFIG)/obj/arc4.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/arc4.o -O2 -fPIC $(DFLAGS) "$(IFLAGS)" src/arc4.c
...
$(CONFIG)/obj/base64.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/base64.o -O2 -fPIC $(DFLAGS) "$(IFLAGS)" src/base64.c
...
$(CONFIG)/obj/bignum.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/bignum.o -O2 -fPIC $(DFLAGS) "$(IFLAGS)" src/bignum.c
...
$(CONFIG)/obj/camellia.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/camellia.o -O2 -fPIC $(DFLAGS) "$(IFLAGS)" src/camellia.c
...
$(CONFIG)/obj/certs.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/certs.o -O2 -fPIC $(DFLAGS) "$(IFLAGS)" src/certs.c
...
$(CONFIG)/obj/debug.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/debug.o -O2 -fPIC $(DFLAGS) "$(IFLAGS)" src/debug.c
...
$(CONFIG)/obj/des.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/des.o -O2 -fPIC $(DFLAGS) "$(IFLAGS)" src/des.c
...
$(CONFIG)/obj/dhm.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/dhm.o -O2 -fPIC $(DFLAGS) "$(IFLAGS)" src/dhm.c
...
$(CONFIG)/obj/havege.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/havege.o -O2 -fPIC $(DFLAGS) "$(IFLAGS)" src/havege.c
...
$(CONFIG)/obj/md2.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/md2.o -O2 -fPIC $(DFLAGS) "$(IFLAGS)" src/md2.c
...
$(CONFIG)/obj/md4.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/md4.o -O2 -fPIC $(DFLAGS) "$(IFLAGS)" src/md4.c
...
$(CONFIG)/obj/md5.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/md5.o -O2 -fPIC $(DFLAGS) "$(IFLAGS)" src/md5.c
...
$(CONFIG)/obj/net.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/net.o -O2 -fPIC $(DFLAGS) "$(IFLAGS)" src/net.c
...
$(CONFIG)/obj/padlock.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/padlock.o -O2 -fPIC $(DFLAGS) "$(IFLAGS)" src/padlock.c
...
$(CONFIG)/obj/rsa.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/rsa.o -O2 -fPIC $(DFLAGS) "$(IFLAGS)" src/rsa.c
...
$(CONFIG)/obj/sha1.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/sha1.o -O2 -fPIC $(DFLAGS) "$(IFLAGS)" src/sha1.c
...
$(CONFIG)/obj/sha2.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/sha2.o -O2 -fPIC $(DFLAGS) "$(IFLAGS)" src/sha2.c
...
$(CONFIG)/obj/sha4.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/sha4.o -O2 -fPIC $(DFLAGS) "$(IFLAGS)" src/sha4.c
...
$(CONFIG)/obj/ssl_cli.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ssl_cli.o -O2 -fPIC $(DFLAGS) "$(IFLAGS)" src/ssl_cli.c
...
$(CONFIG)/obj/ssl_srv.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ssl_srv.o -O2 -fPIC $(DFLAGS) "$(IFLAGS)" src/ssl_srv.c
...
$(CONFIG)/obj/ssl_tls.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ssl_tls.o -O2 -fPIC $(DFLAGS) "$(IFLAGS)" src/ssl_tls.c
...
$(CONFIG)/obj/timing.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/timing.o -O2 -fPIC $(DFLAGS) "$(IFLAGS)" src/timing.c
...
$(CONFIG)/obj/x509parse.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/x509parse.o -O2 -fPIC $(DFLAGS) "$(IFLAGS)" src/x509parse.c
...
$(CONFIG)/obj/xtea.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/xtea.o -O2 -fPIC $(DFLAGS) "$(IFLAGS)" src/xtea.c
...
$(CONFIG)/bin/libest.so: $(DEPS_55)
	...
	$(CC) -shared -o $(CONFIG)/bin/libest.so $(LIBPATHS) "$(CONFIG)/obj/aes.o" "$(CONFIG)/obj/arc4.o" "$(CONFIG)/obj/base64.o" "$(CONFIG)/obj/bignum.o" "$(CONFIG)/obj/camellia.o" "$(CONFIG)/obj/certs.o" "$(CONFIG)/obj/debug.o" "$(CONFIG)/obj/des.o" "$(CONFIG)/obj/dhm.o" "$(CONFIG)/obj/havege.o" "$(CONFIG)/obj/md2.o" "$(CONFIG)/obj/md4.o" "$(CONFIG)/obj/md5.o" "$(CONFIG)/obj/net.o" "$(CONFIG)/obj/padlock.o" "$(CONFIG)/obj/rsa.o" "$(CONFIG)/obj/sha1.o" "$(CONFIG)/obj/sha2.o" "$(CONFIG)/obj/sha4.o" "$(CONFIG)/obj/ssl_cli.o" "$(CONFIG)/obj/ssl_srv.o" "$(CONFIG)/obj/ssl_tls.o" "$(CONFIG)/obj/timing.o" "$(CONFIG)/obj/x509parse.o" "$(CONFIG)/obj/xtea.o" $(LIBS) 
