#
#   est-vxworks-static.mk -- Makefile to build Embedded Security Transport for vxworks
#
...
prep:
	...
	@[ ! -f $(CONFIG)/inc/bit.h ] && cp projects/est-vxworks-static-bit.h $(CONFIG)/inc/bit.h ; true
	@[ ! -f $(CONFIG)/inc/bitos.h ] && cp src/bitos.h $(CONFIG)/inc/bitos.h ; true
	@if ! diff $(CONFIG)/inc/bitos.h src/bitos.h >/dev/null ; then\
		cp src/bitos.h $(CONFIG)/inc/bitos.h  ; \
	fi; true
	@if ! diff $(CONFIG)/inc/bit.h projects/est-vxworks-static-bit.h >/dev/null ; then\
		cp projects/est-vxworks-static-bit.h $(CONFIG)/inc/bit.h  ; \
	fi; true
...
$(CONFIG)/obj/aes.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/aes.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/aes.c
...
$(CONFIG)/obj/arc4.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/arc4.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/arc4.c
...
$(CONFIG)/obj/base64.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/base64.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/base64.c
...
$(CONFIG)/obj/bignum.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/bignum.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/bignum.c
...
$(CONFIG)/obj/camellia.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/camellia.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/camellia.c
...
$(CONFIG)/obj/certs.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/certs.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/certs.c
...
$(CONFIG)/obj/debug.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/debug.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/debug.c
...
$(CONFIG)/obj/des.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/des.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/des.c
...
$(CONFIG)/obj/dhm.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/dhm.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/dhm.c
...
$(CONFIG)/obj/havege.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/havege.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/havege.c
...
$(CONFIG)/obj/md2.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/md2.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/md2.c
...
$(CONFIG)/obj/md4.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/md4.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/md4.c
...
$(CONFIG)/obj/md5.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/md5.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/md5.c
...
$(CONFIG)/obj/net.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/net.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/net.c
...
$(CONFIG)/obj/padlock.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/padlock.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/padlock.c
...
$(CONFIG)/obj/rsa.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/rsa.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/rsa.c
...
$(CONFIG)/obj/sha1.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/sha1.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/sha1.c
...
$(CONFIG)/obj/sha2.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/sha2.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/sha2.c
...
$(CONFIG)/obj/sha4.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/sha4.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/sha4.c
...
$(CONFIG)/obj/ssl_cli.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ssl_cli.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/ssl_cli.c
...
$(CONFIG)/obj/ssl_srv.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ssl_srv.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/ssl_srv.c
...
$(CONFIG)/obj/ssl_tls.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ssl_tls.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/ssl_tls.c
...
$(CONFIG)/obj/timing.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/timing.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/timing.c
...
$(CONFIG)/obj/x509parse.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/x509parse.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/x509parse.c
...
$(CONFIG)/obj/xtea.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/xtea.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/xtea.c
