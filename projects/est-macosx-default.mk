...
$(CONFIG)/inc/aes.h: $(DEPS_1)
	@echo '      [File] macosx-x64-default/inc/aes.h'
	mkdir -p "$(CONFIG)/inc"
...
$(CONFIG)/inc/arc4.h: $(DEPS_2)
	@echo '      [File] macosx-x64-default/inc/arc4.h'
	mkdir -p "$(CONFIG)/inc"
...
$(CONFIG)/inc/base64.h: $(DEPS_3)
	@echo '      [File] macosx-x64-default/inc/base64.h'
	mkdir -p "$(CONFIG)/inc"
...
$(CONFIG)/inc/bignum.h: $(DEPS_4)
	@echo '      [File] macosx-x64-default/inc/bignum.h'
	mkdir -p "$(CONFIG)/inc"
...
$(CONFIG)/inc/bn_mul.h: $(DEPS_7)
	@echo '      [File] macosx-x64-default/inc/bn_mul.h'
	mkdir -p "$(CONFIG)/inc"
...
$(CONFIG)/inc/camellia.h: $(DEPS_8)
	@echo '      [File] macosx-x64-default/inc/camellia.h'
	mkdir -p "$(CONFIG)/inc"
...
$(CONFIG)/inc/certs.h: $(DEPS_9)
	@echo '      [File] macosx-x64-default/inc/certs.h'
	mkdir -p "$(CONFIG)/inc"
...
$(CONFIG)/inc/debug.h: $(DEPS_10)
	@echo '      [File] macosx-x64-default/inc/debug.h'
	mkdir -p "$(CONFIG)/inc"
...
$(CONFIG)/inc/des.h: $(DEPS_11)
	@echo '      [File] macosx-x64-default/inc/des.h'
	mkdir -p "$(CONFIG)/inc"
...
$(CONFIG)/inc/dhm.h: $(DEPS_12)
	@echo '      [File] macosx-x64-default/inc/dhm.h'
	mkdir -p "$(CONFIG)/inc"
...
$(CONFIG)/inc/havege.h: $(DEPS_14)
	@echo '      [File] macosx-x64-default/inc/havege.h'
	mkdir -p "$(CONFIG)/inc"
...
$(CONFIG)/inc/md2.h: $(DEPS_15)
	@echo '      [File] macosx-x64-default/inc/md2.h'
	mkdir -p "$(CONFIG)/inc"
...
$(CONFIG)/inc/md4.h: $(DEPS_16)
	@echo '      [File] macosx-x64-default/inc/md4.h'
	mkdir -p "$(CONFIG)/inc"
...
$(CONFIG)/inc/md5.h: $(DEPS_17)
	@echo '      [File] macosx-x64-default/inc/md5.h'
	mkdir -p "$(CONFIG)/inc"
...
$(CONFIG)/inc/net.h: $(DEPS_18)
	@echo '      [File] macosx-x64-default/inc/net.h'
	mkdir -p "$(CONFIG)/inc"
...
$(CONFIG)/inc/openssl.h: $(DEPS_19)
	@echo '      [File] macosx-x64-default/inc/openssl.h'
	mkdir -p "$(CONFIG)/inc"
...
$(CONFIG)/inc/padlock.h: $(DEPS_20)
	@echo '      [File] macosx-x64-default/inc/padlock.h'
	mkdir -p "$(CONFIG)/inc"
...
$(CONFIG)/inc/rsa.h: $(DEPS_21)
	@echo '      [File] macosx-x64-default/inc/rsa.h'
	mkdir -p "$(CONFIG)/inc"
...
$(CONFIG)/inc/sha1.h: $(DEPS_22)
	@echo '      [File] macosx-x64-default/inc/sha1.h'
	mkdir -p "$(CONFIG)/inc"
...
$(CONFIG)/inc/sha2.h: $(DEPS_23)
	@echo '      [File] macosx-x64-default/inc/sha2.h'
	mkdir -p "$(CONFIG)/inc"
...
$(CONFIG)/inc/sha4.h: $(DEPS_24)
	@echo '      [File] macosx-x64-default/inc/sha4.h'
	mkdir -p "$(CONFIG)/inc"
...
$(CONFIG)/inc/ssl.h: $(DEPS_25)
	@echo '      [File] macosx-x64-default/inc/ssl.h'
	mkdir -p "$(CONFIG)/inc"
...
$(CONFIG)/inc/timing.h: $(DEPS_26)
	@echo '      [File] macosx-x64-default/inc/timing.h'
	mkdir -p "$(CONFIG)/inc"
...
$(CONFIG)/inc/x509.h: $(DEPS_27)
	@echo '      [File] macosx-x64-default/inc/x509.h'
	mkdir -p "$(CONFIG)/inc"
...
$(CONFIG)/inc/xtea.h: $(DEPS_28)
	@echo '      [File] macosx-x64-default/inc/xtea.h'
	mkdir -p "$(CONFIG)/inc"
