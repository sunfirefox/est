#
#   est-linux-static.mk -- Makefile to build Embedded Security Transport for linux
#
...
prep:
	...
	@[ ! -f $(CONFIG)/inc/bit.h ] && cp projects/est-linux-static-bit.h $(CONFIG)/inc/bit.h ; true
	@if ! diff $(CONFIG)/inc/bit.h projects/est-linux-static-bit.h >/dev/null ; then\
		cp projects/est-linux-static-bit.h $(CONFIG)/inc/bit.h  ; \
	fi; true
